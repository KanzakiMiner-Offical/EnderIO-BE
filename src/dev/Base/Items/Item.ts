...
ItemRegistry.createItem("pulsatingCrystal", {
  name: "item.item_material.pulsating_crystal.name",
  icon: "pulsatingCrystal",
  stack: 64,
});
ItemRegistry.createItem("dustPulsating", {
  name: "item.item_material.pulsating_powder.name",
  icon: "pulsatingPowder",
  stack: 64,
});
ItemRegistry.createItem("dustInfinity", {
  name: "item.item_material.powder_infinity.name",
  icon: "dustInfinity",
  stack: 64,
});

ItemRegistry.createItem("binderComposite", {
  name: "item.item_material.binder_composite.name",
  icon: "binderComposite",
  stack: 64,
});
ItemRegistry.createItem("conduitBinder", {
  name: "item.item_material.conduit_binder.name",
  icon: "conduitBinder",
  stack: 64,
});
ItemRegistry.createItem("silicon", {
  name: "item.item_material.silicon.name",
  icon: "silicon",
  stack: 64,
});
EnderCore.createResourceItem("vibrantAlloy", "Vibrant Alloy");
ItemRegistry.createItem("vibrantCrystal", {
  name: "item.item_material.vibrant_crystal.name",
  icon: "vibrantCrystal",
  stack: 64,
});

ItemRegistry.createItem("dustVibrant", {
  name: "item.item_material.vibrant_powder.name",
  icon: "vibrantPowder",
  stack: 64,
});

ItemRegistry.createItem("enderCrystal", {
  name: "item.item_material.ender_crystal.name",
  icon: "enderCrystal",
  stack: 64,
  glint: true,
});
ItemRegistry.createItem("dustEnderCrystal", {
  name: "item.item_material.ender_crystal_powder.name",
  icon: "enderCrystalPowder",
  stack: 64,
  glint: true,
});

ItemRegistry.createItem("weatherCrystal", {
  name: "item.item_material.weather_crystal.name",
  icon: "weatherCrystal",
  stack: 64,
  glint: true,
});

ItemRegistry.createItem("zombieSkull", {
  name: "Zombie Skull",
  icon: "zombieSkull",
  stack: 64,
});
ItemRegistry.createItem("endermanSkull", {
  name: "Enderman Skull",
  icon: "endermanSkull",
  stack: 64,
});
ItemRegistry.createItem("creeperSkull", {
  name: "Creeper Skull",
  icon: "creeperSkull",
  stack: 64,
});
ItemRegistry.createItem("skeletonSkull", {
  name: "Skeleton Skull",
  icon: "skeletonSkull",
  stack: 64,
});
...
Callback.addCallback("PreLoaded", function () {
  ...
  Recipes.addShaped({ id: ItemID.itemYetaWrench, count: 1, data: 0 }, ["e e", " a ", " e "], ["a", ItemID.stoneGear, 0, "e", ItemID.electricalSteel, 0]);

  Recipes.addShaped(
    { id: ItemID.weatherCrystal, count: 1, data: 0 },
    [" a ", "beb", " a "],
    ["a", ItemID.pulsatingCrystal, 0, "e", ItemID.enderCrystal, 0, "b", ItemID.vibrantCrystal, 0],
  );

  Recipes.addShaped({ id: ItemID.vibrantCrystal, count: 1, data: 0 }, ["aaa", "aea", "aaa"], ["a", ItemID.vibrantAlloyNugget, 0, "e", 388, 0]);

  Recipes.addShaped({ id: ItemID.pulsatingCrystal, count: 1, data: 0 }, ["aaa", "aea", "aaa"], ["a", ItemID.pulsatingIronNugget, 0, "e", VanillaItemID.diamond, 0]);
...
ItemRegistry.createItem("skullZombieController", {
  name: "item.item_material.skull_zombie_controller.name",
  icon: "skullZombieController",
  stack: 64,
});
ItemRegistry.createItem("skullZombieElectrode", {
  name: "item.item_material.skull_zombie_electrode.name",
  icon: "skullZombieElectrode",
  stack: 64,
});
...
Callback.addCallback("PreLoaded", function () {
  Recipes.addShaped({ id: ItemID.itemXpTransfer, count: 1, data: 0 }, ["  e", " a ", "e"], ["a", ItemID.energeticAlloy, 0, "e", ItemID.soularium, 0]);
});
