namespace GrindingBall {
  ...
  export function regModBall(id: string, name: string, main: number, bonus: number, powUse: number, dura: number, recipe: IngredientGrinding): void {
    ...
    regItem(id, name);
    idBall[ItemID["ball_" + id]] = { main: (main - 100) / 100, bonus: bonus / 100, use: powUse / 100, durability: Math.floor(dura / 2400) };
    if (!!recipe) {
  ...
  export function regBall(id: string | number, main: number, bonus: number, powUse: number, dura: number): void {
    ...
    idBall[id] = { main: (main - 100) / 100, bonus: bonus / 100, use: powUse / 100, durability: Math.floor(dura / 2400) }
  }
...
GrindingBall.regModBall("dark_steel", "Dark Steel", 135, 200, 70, 125000, { id: "darkSteel", data: 0 })
GrindingBall.regModBall("conductive_iron", "Conductive Iron", 135, 100, 100, 40000, { id: "conductiveIron", data: 0 })
GrindingBall.regModBall("electrical_steel", "Electrical Steel", 120, 165, 80, 40000, { id: "electricalSteel", data: 0 })
...
GrindingBall.regModBall("soularium", "Soularium", 120, 215, 90, 80000, { id: "soularium", data: 0 })
// thermal resource
/*
