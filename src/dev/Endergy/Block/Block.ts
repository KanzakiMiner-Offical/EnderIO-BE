...
EnderCore.createResourceBlock("melodic", "Melodic")
EnderCore.createResourceBlock("stellar", "Stellar")
EnderCore.createResourceBlock("crystallinePink", "Crystalline Pink Slime");
