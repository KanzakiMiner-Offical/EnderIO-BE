BlockRegistry.createBlock("voidMiner", [
    {
        name: "Void Miner",
        texture: [
            ["miner_bottom", 0], ["machineTop", 0], ["machineSide", 0], ["miner", 0], ["machineSide", 0], ["machineSide", 0]],
        inCreative: true
    }
], "machine")

TileRenderer.setHandAndUiModel(BlockID.voidMiner, 0, [["miner_bottom", 0], ["machineTop", 0], ["machineSide", 0], ["miner", 0], ["machineSide", 0], ["machineSide", 0]])
TileRenderer.setStandardModelWithRotation(BlockID.voidMiner, 2, [["miner_bottom", 0], ["machineTop", 0], ["machineSide", 0], ["miner", 0], ["machineSide", 0], ["machineSide", 0]])
TileRenderer.registerModelWithRotation(BlockID.voidMiner, 2, [["miner_bottom", 0], ["machineTop", 0], ["machineSide", 0], ["miner_active", 0], ["machineSide", 0], ["machineSide", 0]])
...
let minerUI = MachineRegistry.createInventoryWindow("Void Miner", {
    ...
    elements: {
        ...
        "progressScale": { type: "scale", x: 200, y: 90, bitmap: "bar_progress1", scale: 3.2 },
