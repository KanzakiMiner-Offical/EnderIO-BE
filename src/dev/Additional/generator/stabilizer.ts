...
TileRenderer.setHandAndUiModel(BlockID.blackholeStabilizer, 0, [
  ["machineBottom", 0],
  ["machineTop", 0],
  ["machineSide", 0],
  ["bh_stabilizer", 0],
...
TileRenderer.setStandardModelWithRotation(BlockID.blackholeStabilizer, 2, [
  ["machineBottom", 0],
  ["machineTop", 0],
  ["machineSide", 0],
  ["bh_stabilizer", 0],
...
TileRenderer.registerModelWithRotation(BlockID.blackholeStabilizer, 2, [
  ["machineBottom", 0],
  ["machineTop", 0],
  ["machineSide", 0],
  ["bh_stabilizer", 0],
