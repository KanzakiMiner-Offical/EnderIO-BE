BlockRegistry.createBlock("blackholeControler", [
    {
        name: "Black Hole Controler",
        texture: [
            ["machineBottom", 0], ["bh_controler_top", 0], ["bh_controler", 0], ["bh_controler", 0], ["bh_controler", 0], ["bh_controler", 0]],
        inCreative: true
    }
], "machine")
...
let controlerUI = MachineRegistry.createInventoryWindow("Black Hole Controler", {
    drawing: [
        { type: "bitmap", x: 135, y: 140, bitmap: "redflux_bar0", scale: 3.2 }
    ],
    elements: {
        "energyScale": {
            type: "scale",
