...
(function (EnergyRegistry) {
  ...
  function registerWire(blockID, type, maxValue, energyGridClass) {
    if (energyGridClass === void 0) {
      energyGridClass = EnergyGrid;
    }
...
var EnergyNode = /** @class */ (function () {
  ...
  EnergyNode.prototype.toString = function () {
    return "[EnergyNode id="
      .concat(this.id, ", type=")
      .concat(this.baseEnergy, ", entries=")
      .concat(this.entries.length, ", receivers=")
      .concat(this.receivers.length, ", energyIn=")
      .concat(this.energyIn, ", energyOut=")
      .concat(this.energyOut, ", power=")
      .concat(this.energyPower, "]");
  };
  return EnergyNode;
})();
...
(function (EnergyTileRegistry) {
  ...
  function setupAsEnergyTile(Prototype) {
    ...
    Prototype.energyReceive =
      Prototype.energyReceive ||
      function () {
        return 0;
      };
    Prototype.isConductor =
      Prototype.isConductor ||
      function () {
        return false;
      };
    Prototype.canReceiveEnergy =
      Prototype.canReceiveEnergy ||
      function () {
        return true;
      };
    Prototype.canExtractEnergy =
      Prototype.canExtractEnergy ||
      function () {
        return true;
      };
